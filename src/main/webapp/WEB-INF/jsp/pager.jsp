...
<link href="/source/css/pager.css" rel="stylesheet" type="text/css" />
...
<c:choose>
    ...
    <span>页</span>
    <%-- <a href="javascript:_go();" class="aSubmit aBtn">确定</a>--%>
    <input type="button" onclick="_go()" value="确定" class="aSubmit">
  </div>
</div>